...
namespace glm
{
	...
	//		return false;
	//
	//	genType translationVector = orig - vert0;
	//
	//	position.y = dot(translationVector, pvec);
	//	if (position.y < typename genType::value_type(0) || position.y > det)
	//		return typename genType::value_type(0);
	//
	//	genType qvec = cross(translationVector, edge1);
	//
	...
	)
	{
		...
		position.y = dot(translationVector, pvec) * inv_det;
